    ...
    <>
      <div class="d-flex flex-row justify-content-around flex-wrap bd-highlight m-5">
        ...
        <div class="d-flex justify-content-sm-center flex-column bd-highlight">
          ...
          <div class="box bd-highlight text-justify pb-3">
            <h5 className="text-secondary" style={{ "font-weight": "300" }}>
              ...
              lifetime. Odor to yummy high racy bonus soaking mouthwatering.
              First superior full-bodied drink. Like outstanding odor economical
              deal clinically
            </h5>
          </div>
          <div class="box d-flex flex-row bd-highlight flex-wrap justify-content-around">
            ...
            <a className="text-center icon">
              ...
              <h5 style={{ "font-weight": "500" }}>Modern Techniques</h5>
            </a>
            <a className="text-center icon">
              <img src={icon3} className="m-2" width="70px" />
              <h5 style={{ "font-weight": "500" }}>Farm Factory</h5>
            </a>
            <a className="text-center icon">
              <img src={icon4} className="m-2" width="70px" />
              <h5 style={{ "font-weight": "500" }}>Fresh Vegetables</h5>
            </a>
            <a className="text-center icon">
              <img src={icon5} className="m-2" width="70px" />
              <h5 style={{ "font-weight": "500" }}>Rent Machines</h5>
            </a>
          </div>
        </div>
      </div>
